...
$\begin{aligned} (2)同一律: & A \cap U = A, A \cup U = U, \\ & A \cap \varnothing = \varnothing, A \cup \varnothing = A; \end{aligned}$  
$(3)互补律: A \cap \complement_U{A} = \varnothing, A \cup \complement_U{A} = U;$  
$(4)交换律: A \cap B = B \cap A, A \cup B = B \cup A;$  
$\begin{aligned} (5)结合律: & A \cap (B \cap C) = (A \cap B) \cap C, \\ & A \cup (B \cup C) = (A \cup B) \cup C; \end{aligned}$  
$\begin{aligned} (6)分配律: & A \cap (B \cup C) = (A \cap B) \cup (A \cap C), \\\\ & A \cup (B \cap C) = (A \cup B) \cap (A \cup C); \end{aligned}$  
$(7)吸收律: A \cup (A \cap B) = A, A \cap (A \cup B) = A;$  
$\begin{aligned} (8)反演律(摩根律): & \complement_U{(A \cap B)} = \complement_U{A} \cup \complement_U{B}, \\ & \complement_U{(A \cup B)} = \complement_U{A} \cap \complement_U{B} \end{aligned}$  
