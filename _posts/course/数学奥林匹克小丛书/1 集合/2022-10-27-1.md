...
$$
\begin{aligned} 
    (1) & A_i \cap A_j = \varnothing, 1 \leq i, j \leq i \neq j; \\
...
$$A_1 \cap A_2 \cap \cdots \cap A_n = \cap_{i = 1}^{n}{A_i} = M , \tag{i}$$
...
$$A_i \cap A_j = \varnothing, 1 \leq i \neq j \leq n, \tag{(ii)}$$
...
如果条件 $(\text{ii})$ 不一定满足$,$ 也就是说可能存在 $1 \leq p \neq q leq n$ 使
...
$$\lvert A_1 \cup A_2 \rvert = \lvert A_1 \rvert + \lvert A_2 \rvert - \lvert A_1 \cap A_2 \rvert. \tag{I}$$

**证明** 设 $A_1 \cap A_2 = B, A_1' = A_1 - B, A_2' = A_2 - B,$ 则
...
$$
\begin{aligned}
    \lvert A_1 \cup A_2 \rvert & = \lvert A_1' \cup A_2' \cup B \rvert = \lvert A_1' \rvert + \lvert A_2' \rvert + \lvert B \rvert \\
    & = (\lvert A_1 \rvert - \lvert B \rvert ) + (\lvert A_2 \rvert - \lvert B \rvert) + \lvert B \rvert \\
    & = \lvert A_1 \rvert + \lvert A_2 \rvert - \lvert A_1 \cap A_2 \rvert.
\end{aligned}
$$

**定理 $2$** 设 $A_1$、$A_2$ 是集合 $S$ 的子集$,$ 则

$$\lvert \complement_S A_1 \cap \complement_S A_2 \rvert = \lvert S \rvert - \lvert A_1 \rvert - \lvert A_2 \rvert + \lvert A_1 \cap A_2 \rvert. \tag{II}$$

**证明** 由摩根定律及加法原理有

$$\lvert \complement_S A_1 \cap \complement_S A_2 \rvert = \lvert \complement_S (A_1 \cup A_2) \rvert = \lvert S \rvert - \lvert A_1 \cup A_2 \rvert.$$

又由定理 $1$ 得到

$$\lvert \complement_S A_1 \cap \complement_S A_2 \rvert = \lvert S \rvert - \lvert A_1 \rvert - \lvert A_2 \rvert + \lvert A_1 \cap A_2 \rvert.$$
